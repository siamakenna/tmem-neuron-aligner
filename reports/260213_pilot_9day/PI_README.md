...
Run started: 2026-07-12T23:08:14
...
Timepoints: 8, 12, 16, 20, 25, 29, 32, 36, 39
...
For each well, the script loaded the first 9 fluorescence ND2 timepoints,
...
E05 (PLD3_mCherry_reporter_control) increased from 2.493 to 3.605 (slope 0.1244 per day). F05 (PLD3_TMEM106B_mCherry_primary) increased from 3.013 to 24.17 (slope 0.5667 per day).
...
- The current pilot has 18/18 registration QC rows passing.
